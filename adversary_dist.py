import sys
import math
import oneShot_a_dist, combine_a_dist
...
if __name__ == '__main__':
    ...
    ret1 = oneShot_a_dist.runUtilHeight(targetHeight, invFaultyRate, iteration)
    ret2 = combine_a_dist.runUtilHeight(targetHeight, invFaultyRate, iteration)
